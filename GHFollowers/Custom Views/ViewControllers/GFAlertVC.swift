...
class GFAlertVC: UIViewController {
    ...
    private let titleLabel = GFTitleLabel(textAlignment: .center, fontSize: 15)
    ...
    override func viewDidLoad() {
        ...
        configureMeassageLabel()
    }

    
    //MARK: UI and Constraints configuration
    ...
    private func configureMeassageLabel(){
